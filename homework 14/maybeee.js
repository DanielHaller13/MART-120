document.addEventListener('DOMContentLoaded', function() {
    ...
    let obstacles = [
      ...
      { x: 200, y: 300, width: 40, height: 40, color: 'green', speedX: -3, speedY: 1 },
      { x: 400, y: 150, width: 20, height: 20, color: 'purple', speedX: 4, speedY: -2 },
      { x: 500, y: 400, width: 35, height: 35, color: 'orange', speedX: -2, speedY: 4 },
      { x: 600, y: 250, width: 25, height: 25, color: 'yellow', speedX: 3, speedY: -4 }
    ];
